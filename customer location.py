...
df= pd.read_csv('E:/SIDDHARTH/engineering stuff & programming/NPCI HackerEarth API/dash-nlp/data/customer26.csv')
...
fp = "E:/SIDDHARTH/engineering stuff & programming/NPCI HackerEarth API/Igismap/Indian_States.shp"
...
fig.savefig("E:/SIDDHARTH/engineering stuff & programming/NPCI HackerEarth API/dash-nlp/State_wise.png", dpi=100)
